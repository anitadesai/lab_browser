...
public class BrowserModel {
	 ...
	 */
	public BrowserModel (String initialLanguage) {
	...
	public URL getFavorite (String name) {
		try {
			...
			throw new BrowserException(String.format(myResources.getString("ErrorOnGetFavorite"), name));
		}
		return null;
	}
		...
		try {
			...
			try {
				...
				try {
					...
					throw new BrowserException(String.format(myResources.getString("ErroronCompleteURL"), possible));
				}
			}
		}
	}
